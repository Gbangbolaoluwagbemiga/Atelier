...
[![Tests](https://img.shields.io/badge/tests-250%20passing-5FD39A?style=flat-square)](#testing)
...
**250 tests.** The contract suite went from zero.

| Suite | Count | What it covers |
|---|--:|---|
| Contract | **86** | Delegation, upgrade safety, productive escrow, self-dealing, whole-journey E2E |
