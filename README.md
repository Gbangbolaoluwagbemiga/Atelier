...
| [`app/contracts/solidity/`](app/contracts/solidity) | `Atelier.sol`, the yield controller and adapters, 179 Foundry tests |
...
**947 tests.** The contract suite went from zero.

| Suite | Count | What it covers |
|---|--:|---|
| Contract | **179** | Delegation, upgrade safety, productive escrow, the yield waterfall, self-dealing, whole-journey E2E |
...
```bash
(cd app/contracts/solidity && forge test)   # 179
(cd app && npm test)                        # 447
