...
[![Tests](https://img.shields.io/badge/tests-519%20passing-5FD39A?style=flat-square)](#testing)
...
**519 tests.** The contract suite went from zero.

| Suite | Count | What it covers |
|---|--:|---|
| Contract | **139** | Delegation, upgrade safety, productive escrow, the yield waterfall, self-dealing, whole-journey E2E |
| Frontend | **207** | Actor semantics, nav, error humanising, worker session, brief reconciliation, job-card badges, the yield switch |
...
```bash
(cd app/contracts/solidity && forge test)   # 139
(cd app && npm test)                        # 207
